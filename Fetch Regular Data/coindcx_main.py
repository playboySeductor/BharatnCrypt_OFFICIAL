...
Author: Trade With Python (BharatNCrypt)
...
if __name__ == '__main__':
    ...
    st.header("Know More About Crypto With BharatNCrypt")

    with st.expander(label = "Click Here to Expand", expanded = True):
        st.write("""**BharatNCrypt** started in February 2022 with the mission to help **Noob Investors** about Crypto Trading - Trading by specifically using tools and strategies that work 
                    in the real market. Our blogs are very simple to understand and are written by contributors who know Finance and Technology.""")

        

        
        st.write("""**Founder: BharatNCrypt**""")
        st.markdown("""Reach out to BharatNCrypt on Linkedin: https://www.linkedin.com/in/saptarshi-pani-849952219/""")
        st.markdown("""Reach out to BharatNCrypt on Email :email:: pani.saptarshi@gmail.com """)
